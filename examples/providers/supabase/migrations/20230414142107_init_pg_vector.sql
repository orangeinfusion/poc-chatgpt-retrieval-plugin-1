...
create table if not exists documents (
    ...
    embedding vector(3072) -- 256 is the default dimension, change depending on dimensionality of your chosen embeddings model
);
...
create or replace function match_page_sections(in_embedding vector(3072) -- 256 is the default dimension, change depending on dimensionality of your chosen embeddings model
